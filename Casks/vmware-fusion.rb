cask "vmware-fusion" do
    ...
    url "https://proxy.cf.iamrazo.pro/softwareupdate.vmware.com/cds/vmw-desktop/fusion/#{version.csv.first}/#{version.csv.second}/universal/core/com.vmware.fusion.zip.tar"
    name "VMware Fusion"
    desc "Create, manage, and run virtual machines"
    homepage "https://www.vmware.com/products/fusion.html"
  
    livecheck do
      url "https://proxy.cf.iamrazo.pro/softwareupdate.vmware.com/cds/vmw-desktop/fusion-universal.xml"
